...
import { WebComponentLinkPassword,
    NativeComponentLinkPassword }   from './login'
import Button				        from "../../widgets/button"
import ProgressBar 			        from "../../widgets/progress-bar"
import {passwordBarColor, 
        passwordProgress}           from './register'
import { Section, 
         Column,
         Row, 
         Group,
...
export default function PasswordReset() {
    ...
    return (
        <>
        <Section of="group" 
                 style={{width: 375, maxWidth: 560, alignSelf: "center", height: 350}}>
			<Column of="group">
