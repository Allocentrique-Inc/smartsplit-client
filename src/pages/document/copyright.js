...
export default function CopyrightShare(props) {
    ...
    <Row of="component">
        <View style={[MediaStyles.cover, props.style]} margin="medium">
            ...
            <Heading level="5" color="primary">Documentation</Heading>
            </Flex>
    ...
    <Row>
        ...
        <Text action heavy>CRÉATION</Text>
    </Row>

    <Paragraph>Ici, on crée les crédits qui décrivent ta pièce. 
        Tu vas pouvoir indiquer qui a fait quoi, quand, 
        où et avec quels instrument.</Paragraph>

<Column layer="underground">
    <Text tertiary heavy>AIDE</Text> 
    <Row>
       <Dropdown 
       placeholder="C'est quoi un créateur ?"
       />
    </Row>
</Column>
...
<Column>
    ...
    <Row>
       ...
       <Dropdown 
       placeholder="Qui a écrit les paroles de cette pièce musicale ?"
       />
    ...
    <Row>
       ...
       <Dropdown 
       placeholder="Qui a composé la musique de cette pièce musicale ?"/>
