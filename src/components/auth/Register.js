                ...
                <Translation>
                    {
                        t=>                               
                            <Form>
                                <span className="top">
                                    <a href="/register">{t('entete.inscription')}</a>
                                </span>
                                        ...
                                        <div className="container">
                                            <div className="field">
                                                <div className="control">
                                                    ...
                                                    } } name="username" id="username" aria-describedby="userNameHelp" placeholder={t('inscription.exemple')} value={this.state.username} required={true} />
                                                ...
                                                <div className="field">
                                                    <div className="control has-icons-left">
                                                        ...
                                                        <div className="input-wrapper">
                                                            ...
                                                            } } type={this.state.hidden ? "password" : "text"} id="password" name="password" placeholder={t('inscription.password')} value={this.state.password} onChange={this.handlePasswordChange}
                                            ...
                                            <div className={confirmClass}>
                                                <div className="control has-icons-left confirmPassword">
                                                    ...
                                                    <div className="input-wrapper">
                                                        ...
                                                        } } type={this.state.confirmhidden ? "password" : "text"} id="confirmpassword" name="confirmpassword" placeholder="Confirm password" value={this.state.confirmpassword} onChange={this.handleConfirmPasswordChange} required={true} className={controlClass} />
                                                ...
                                                <div className="d-flex flex-row justify-content-between align-items-center px-3 mb-5">
                                                    ...
                                                    <p className="control">
                                                        ...
                                                        <button className="ui medium button account is-success" type="submit">
