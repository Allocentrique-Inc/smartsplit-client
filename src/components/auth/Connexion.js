	...
	render() {
		...
		return (
			...
			> */}
				...
				{this.state.opened === TYPE_REGISTER && (
					<Register parent={this} pochette={this.state.pochette} />
				)}
				...
				{this.state.opened === TYPE_FORGOT && (
					<ForgotPassword pochette={this.state.pochette} parent={this} />
				)}
			</React.Fragment>
		)
	}
