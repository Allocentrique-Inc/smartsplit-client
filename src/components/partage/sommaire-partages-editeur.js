						...
						<div className="ui sixteen wide column">
							<div className="ui row" style={{ marginBottom: "1rem" }}>
								...
								>
									<div
										className="fleche"
										style={{ paddingRight: "0.5rem", paddingTop: "1rem" }}
									>
							...
							<Modal.Content className="invitation">
								...
								<PageAssistantSplitCourrielsCollaborateurs
									...
									onSubmit={() => {
										...
										axios
											.post(`${config.API_URL}editorsplitshare/invite`, body)
											.then(() => {
												toast.success(t("flot.invitations.envoyees"))
												setTimeout(() => {
													utils.naviguerVersPartageEditeur(
					...
					{!this.state.creerNouveauPartage && (
						<div className="ui row">
									...
									<div className="boutons sommaire">
										<div style={{ textAlign: "right" }}>
											...
											{!envoiDisabled && (
												...
												>
													{t(
														"flot.split.documente-ton-oeuvre.proposition.envoyer-editeur"
													)}
												</div>
											)}
										</div>
							...
							<div className="ui row">
								...
								<Accordion fluid>{propositions}</Accordion>
								<div className="ui two wide column" />
							</div>
