...
export default class VotationPartTiers extends Component {
  ...
  componentWillMount() {
    ...
    axios
      .post("http://dev.api.smartsplit.org:8080/v1/proposal/decode", body)
      .then(resp => {
        let _s = resp.data;
        ...
        axios
          .get(
            `http://dev.api.smartsplit.org:8080/v1/rightHolders/${_s.beneficiaire}`
          )
          .then(res => {
            ...
            axios
              .get(
                `http://dev.api.smartsplit.org:8080/v1/proposal/${_s.proposalId}`
              )
              .then(_r => {
                ...
                axios
                  .get(
                    `http://dev.api.smartsplit.org:8080/v1/media/${_r.data.Item.mediaId}`
                  )
                  .then(_rMedia => {
                    ...
                    axios
                      .get(
                        `http://dev.api.smartsplit.org:8080/v1/splitShare/${this.state.jeton.proposalId}/${this.state.jeton.donateur}`
                      )
                      .then(res => {
