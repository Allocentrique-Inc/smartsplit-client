...
export default class Navigation extends Component {
    ...
    genererLien(choix, t, classes) {
        return (
            <i onClick={()=>{this.naviguer(choix)}} className={`${classes} ${this.state.selection === choix ? 'green' : 'grismauve'}`} style={
                {
                    display: "block",
                    cursor: "pointer",
                    textAlign: "left",
                ...
                <span className={`${this.state.selection === choix ? 'tdb--lien__actif' : `tdb--lien__inactif`}`} style={{marginLeft: "20px"}}>{t('tableaudebord.navigation.' + choix)}</span></i>
            )
    }
